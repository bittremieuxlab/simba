...
if load_train_val_test_data:
    ...
    if load_neurips_spectra:
        ...
        all_spectrums_neurips = loader_saver.get_all_spectra(
            neurips_path,
    ...
    pp = Preprocessor()
    all_spectrums = pp.return_valid_spectra_n_peaks(
        all_spectrums, min_peaks=config.MIN_N_PEAKS
    )
...
print(
    f"Time difference in minutes for training pairs: {minutes_difference:.2f} minutes"
)
