...
nvidia-smi 
srun python inference_multitasking.py --enable_progress_bar=0   --extra_info=_multitasking_mces20raw_20241017 --use_cosine_distance=1 --USE_EDIT_DISTANCE_REGRESSION=0 --BEST_MODEL_NAME=last.ckpt
