...
srun  python inference_multitasking.py  --enable_progress_bar=0   --ADD_HIGH_SIMILARITY_PAIRS=0 --extra_info=_generated_data_peak_dropout --USE_MCES20_LOG_LOSS=1 --use_cosine_distance=1 --USE_LOSS_WEIGHTS_SECOND_SIMILARITY=1 --load_pretrained=1 --LR=0.00001
