...
srun  python inference_multitasking_fingerprint.py --enable_progress_bar=0   --CHECKPOINT_DIR=/scratch/antwerpen/209/vsc20939/data/model_checkpoints/model_256n_multitasking_fingerprint/ --USE_FINGERPRINT=1
