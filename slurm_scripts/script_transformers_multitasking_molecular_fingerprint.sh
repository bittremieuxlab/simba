...
nvidia-smi 
srun python training_multitasking_molecular_fingerprint.py --enable_progress_bar=0   --extra_info=_multitasking_MOLECULAR_FINGERPRINT --USE_MCES20_LOG_LOSS=1 --use_cosine_distance=0 --USE_LOSS_WEIGHTS_SECOND_SIMILARITY=0 --USE_MOLECULAR_FINGERPRINTS=1
