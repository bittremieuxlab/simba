...
nvidia-smi 
srun python training_multitasking_contrastive.py --enable_progress_bar=0   --extra_info=_contrastive_500million --USE_MCES20_LOG_LOSS=0 --use_cosine_distance=1 --USE_LOSS_WEIGHTS_SECOND_SIMILARITY=1 
