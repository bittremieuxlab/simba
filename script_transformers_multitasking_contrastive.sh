...
nvidia-smi 
srun python training_multitasking_contrastive.py --enable_progress_bar=0  --D_MODEL=128 --extra_info=_contrastive_20250128 --USE_MCES20_LOG_LOSS=0 --use_cosine_distance=1 --USE_LOSS_WEIGHTS_SECOND_SIMILARITY=1 --PREPROCESSING_DIR=/scratch/antwerpen/209/vsc20939/data/preprocessing_mces_threshold20_newdata_20240925/
