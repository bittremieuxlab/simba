...
nvidia-smi 
srun python training_multitasking.py --enable_progress_bar=0   --extra_info=_multitasking_20241031_simetric_penalty --USE_MCES20_LOG_LOSS=1 --use_cosine_distance=0 --USE_LOSS_WEIGHTS_SECOND_SIMILARITY=0
