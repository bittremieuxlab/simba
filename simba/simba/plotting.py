...
class Plotting:
    ...
    def plot_mces(similarities_test2, flat_pred_test2, remove_threshold_values=True, threshold_mces=20):
        ...
        plot = sns.jointplot(x=x, y=y, kind="hex", color="#4CB391", joint_kws=dict(alpha=1, gridsize=20))
        # Set x and y labels
