...
class MatchmsUtils:
    ...
    def from_su_to_matchms_metadata(original_dict):
        ...
        new_dict= {
            ...
            'precursor_mz': original_dict['pepmass'][0] if 'pepmass' in original_dict.keys() else original_dict['precursor_mz'],
    ...
    def from_su_to_matchms(spectrum_su):
        ...
        spectrum_matchms = Spectrum(mz=np.array(spectrum_su.mz),
