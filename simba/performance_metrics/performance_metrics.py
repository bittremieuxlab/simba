...
class PerformanceMetrics:
    ...
    def filter_by_correctness(
        similarities1, predictions1, similarities2, predictions2, good_predictions=True
    ):
    ...
    def get_correct_predictions(
        similarities1, predictions1, similarities2, predictions2
    ):
        """
        return the correct predictions
        """
        return PerformanceMetrics.filter_by_correctness(
            similarities1,
            predictions1,
            similarities2,
            predictions2,
            good_predictions=True,
        )
    ...
    def plot_molecules(
        ...
        target_indexes = np.random.choice(
            np.reshape(target_indexes, -1), size=target_indexes.shape[0], replace=False
        )
        ...
        predictions_target_mces = [
            predictions_target_mces[int(index)] for index in target_indexes
        ]

        similarities_target_ed = [
            similarities_target_ed[int(index)] for index in target_indexes
        ]
        similarities_target_mces = [
            similarities_target_mces[int(index)] for index in target_indexes
        ]
