...
class MoleculePairsOpt(MolecularPairsSet):
    ...
    '''
    def __init__(self, spectrums_original, spectrums_unique , df_smiles,indexes_tani_unique):
        """
        ...
        self.indexes_tani = MolecularPairsSet.adjust_data_format(np.array(indexes_tani_unique))